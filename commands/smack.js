exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('You can\'t smack your self dummy!');
  if(message.mentions.users.first().id === "242263403001937920") return message.reply('You can\'t hurt yourself dummy.');
